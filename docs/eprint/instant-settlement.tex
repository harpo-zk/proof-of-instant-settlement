...
\textbf{\code{finalize(proof)} --- complete settlement (v2: $352{,}983$)} & $\mathbf{353{,}315}$ \\
...
\code{finalize} costs $332$ gas more (one \code{keccak256} over 64 bytes plus
the extra calldata word for the cross-check) --- both consistent with the
single-word binding storage of \S\ref{sec:oracle} rather than a fresh storage
slot. The complete settlement transaction costs $353{,}315$ gas. An
\emph{isolated} call to the verifier contract with the same proof and public
signals costs $243{,}194$ gas --- including its own $21{,}000$ base
...
$243{,}194$ is an upper bound on the verifier's share of the $353{,}315$, not a
